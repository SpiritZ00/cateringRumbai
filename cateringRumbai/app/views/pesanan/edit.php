    ...
    <div class="admin-shell">
        <aside class="admin-sidebar">
            <div class="sidebar-header">
                <a class="brand-mark" href="index.php">Catering Rumbai</a>
            </div>
            <nav class="sidebar-nav">
                <a class="nav-link" href="?aksi=index">Data Pesanan</a>
                <?php if (isset($_SESSION['jabatan']) && $_SESSION['jabatan'] === 'admin'): ?>
                    <a class="nav-link" href="?aksi=list_user">Data User</a>
                <?php endif; ?>
                <a class="nav-link text-danger" href="?aksi=logout">Logout</a>
            </nav>
        </aside>
